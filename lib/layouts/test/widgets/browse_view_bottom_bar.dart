    ...
    return Obx(() => BottomBar(
          action1: IconButton(
            ...
            icon: Icon(MdiIcons.viewDashboard,
                color: controller.iCurrentSelect == 1 ? Colors.purple : Colors.blueGrey),
            onPressed: () => controller.tabFunction(1),
          ),
          action2: IconButton(
            tooltip: 'Worksapace',
            icon: Icon(MdiIcons.briefcaseOutline,
                color: controller.iCurrentSelect == 2 ? Colors.purple : Colors.blueGrey),
            onPressed: () => controller.tabFunction(2),
          ),
          action5: IconButton(
            tooltip: 'Folder',
            icon: Icon(MdiIcons.archiveOutline,
                color: controller.iCurrentSelect == 3 ? Colors.purple : Colors.blueGrey),
          ...
          action3: IconButton(
              ...
              icon: Icon(MdiIcons.cubeOutline, //ellipsis
                  color: controller.iCurrentSelect == 4 ? Colors.purple : Colors.blueGrey),
          ...
          action4: IconButton(
            ...
            icon: Icon(
              MdiIcons.web,
              color: controller.iCurrentSelect == 5 ? Colors.purple : Colors.blueGrey,
            ),
