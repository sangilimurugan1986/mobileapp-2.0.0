...
class TabMianScanState extends State<TabMianScan> with SingleTickerProviderStateMixin {
  @override
  void initState() {
    super.initState();
  }
    ...
    return ListView(
      ...
      children: <Widget>[
        ...
        Align(
            ...
            child: Fab(icon: MdiIcons.plus, onPressed: () {}, color: BrandColors.primary.shade300))
      ],
    );
  }
}
