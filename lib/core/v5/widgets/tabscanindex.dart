            ...
            Expanded(
                ...
                child: Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                      IconButton(
                        icon: Icon(MdiIcons.chevronLeft, color: Colors.grey),
                        onPressed: () {
                          //backfn();
                          setState(() {
                      ...
                      Expanded(
                          ...
                          child: Container(
                              ...
                              child: Obx(() => Text(controllers.ipageval.string,
                                  style: TextStyle(color: Colors.white))))),
                      IconButton(
                        icon: Icon(MdiIcons.chevronRight, color: Colors.grey),
                        onPressed: () {
                          //backfn();
                          setState(() {
                            controllers.ipageval.value = controllers.ipageval.value + 1;
                          });
                        },
                      )
                    ]))),
